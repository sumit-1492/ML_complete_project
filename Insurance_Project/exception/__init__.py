...
class InsuraneceException(Exception):

    def __init__(self,error_message:Exception, error_detail:sys):
        super().__init__(error_message)
        self.error_message = InsuraneceException.error_message_detail(error_message,error_detail=error_detail)
    @staticmethod
    ...
    def __str__(self):
        return InsuraneceException.__name__.__str__()
